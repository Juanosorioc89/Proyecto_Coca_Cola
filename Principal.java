...
public class Principal extends JFrame implements ActionListener{
	...
	private TextField txtNombreTrabajador, txtAPaternoTrabajador, txtAMaternoTrabajador;
	...
	public Principal(){
	  ...
	  labelNombre.setFont(new Font("Andale Mono",0,12));
	  labelNombre.setForeground(new Color(255,255,255));
	  add(labelNombre);
	  
	  txtNombreTrabajador = new TextField();
	  ...
	  txtAPaternoTrabajador = new TextField();
	  ...
	  txtAMaternoTrabajador = new TextField();
	  ...
	  textarea1.setText("\n	Aquí aparece el resultado de las vacaciones.");
	...
	public void actionPerformed(ActionEvent e){
		...
		if (e.getSource() == miElCreador){
			...
			JOptionPane.showMessageDialog(null, "Desarrollado por Hibahsoft S.A.");
		}
	}
